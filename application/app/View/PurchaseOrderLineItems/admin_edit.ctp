...
<?php echo $this->Form->create('PurchaseOrderLineItem'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Purchase Order Line Item'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PurchaseOrderLineItem.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('PurchaseOrderLineItem.id')))); ?></li>
